...
<body>
    <div class="error-card">
        <a href="{{ url('/') }}">
            <img src="{{ asset('images/logo_header.png') }}" alt="HAMDANS" class="logo" onerror="this.src='/images/logo_kemenham.png'">
        </a>
        ...
        <p class="error-desc">
            @yield('description', 'Maaf, terjadi kendala saat memuat halaman ini.')
        </p>
