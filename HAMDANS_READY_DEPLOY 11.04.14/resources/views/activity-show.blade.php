    ...
    <div class="article-container">
        ...
        <div class="source-section">
            <div class="source-header">
                ...
                <span class="source-header-text" data-i18n="source">Sumber Referensi</span>
            </div>
            <div class="source-body" style="display: flex; flex-direction: column; gap: 0.75rem;">
                @foreach($links as $link)
                    ...
                    <div style="display: flex; flex-direction: column; gap: 0.25rem;">
                        <span style="font-size: 0.75rem; font-weight: 600; color: var(--gray-500); text-transform: uppercase; letter-spacing: 0.05em;">{{ $platformLabel }}</span>
                        <a href="{{ $link['url'] ?? '#' }}" target="_blank" rel="noopener" class="source-link">
                            ...
                            @endif
                            <span style="overflow: hidden; text-overflow: ellipsis; white-space: nowrap; max-width: 80%;">{{ $link['url'] ?? '' }}</span>
